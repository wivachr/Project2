...
<table width="36%" border="0" cellpadding="0" cellspacing="1">
    <tr>
      <td width="79%" align="center" bgcolor="#CCCCCC">สิทธิ์</td>
      <td width="21%" bgcolor="#CCCCCC"></td>
    </tr>
 <? include('../../connectdatabase.php');
$sql = "select * from `right` ORDER BY id_right";
$result = mysqli_query($connect, $sql);
while($rs = mysqli_fetch_array($result))
{
	 $sql = "select * from user where id_right='$rs[0]'";
