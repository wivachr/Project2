      ...
      <table width="500" cellspacing="0">
        <tr bgcolor="#999999">
          <td height="30" colspan="2" align="center"><h2>ข่าวประกาศจากภาควิชา</h2></td>
			  ...
			  $safetopic = htmlspecialchars($rs[1],ENT_QUOTES);
			  $safeid = (int)$rs[0];
			  if($rs[0]%2==1)
              echo "<tr bgcolor='#CCCCCC' align='left'><td><img src='image/icon_01new.gif' width='15' height='11' /> <a href='news/viewnews.php?id=$safeid' target='_blank'>$safetopic</a>$pdflink$imglink</td><td align='right'>$date2[2]/$date2[1]/$date2[0]</td></tr>";
			  else
              echo "<tr bgcolor='#E9E9E9' align='left'><td><img src='image/icon_01new.gif' width='15' height='11' /><a href='news/viewnews.php?id=$safeid' target='_blank'> $safetopic</a>$pdflink$imglink</td><td align='right'>$date2[2]/$date2[1]/$date2[0]</td></tr>";
			  }
			  ?>
      </table>
            <br/>
