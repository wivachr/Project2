...
$(document).ready(function() {
	...
	?>
	 	 ...
	 	 function assigningex(id,idsubmit)
	 {
...
OR committee.id_teacher = '$t[2]'
	...
	?>
		...
		var str = Math.random();
		var  qstr ="project/assigningexam.php?pop="+str;
...
<table width="100%" border="0">
  <tr>
    <td colspan="2" align="center"><h3>จัดสอบหัวข้อโครงงานพิเศษ รหัส <?=$id?></h3>
          <?  
include('../connectdatabase.php'); 
	  $num = 0;
...
<p>
  ...
  <tr>
    <td colspan="2" align="center"><input type="button" name="assigexb" id="assigexb" value="จัดสอบ" onclick="assigningex(<?=$id?>,<?=$idsubmit?>)" />
...
<table width="56%" border="1">
  ...
  {
	  ?>
      <td align="center" id="M<?=$i?>" bgcolor="#99FF99">&nbsp;</td>
      <?
  }
  ?>
  </tr>
  ...
  {
	  ?>
      <td align="center" id="T<?=$i?>" bgcolor="#99FF99">&nbsp;</td>
      <?
  }
  ?>
  </tr>
  ...
  {
	  ?>
      <td align="center" id="W<?=$i?>" bgcolor="#99FF99">&nbsp;</td>
      <?
  }
  ?>
  </tr>
  ...
  {
	  ?>
      <td align="center" id="H<?=$i?>" bgcolor="#99FF99">&nbsp;</td>
      <?
  }
  ?>
  </tr>
  ...
  {
	  ?>
      <td align="center" id="F<?=$i?>" bgcolor="#99FF99">&nbsp;</td>
      <?
  }
  ?>
  </tr>
