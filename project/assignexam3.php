...
$(document).ready(function() {
	...
	?>
	 ...
	 function assigningex3(id,idsubmit)
	 {
		 			var b = true;
			var a = true;
...
OR committee.id_teacher = '$t[2]'
	...
	?>
		...
		var str = Math.random();
		var  qstr ="project/assigningexam3.php?pop="+str;
...
<table width="100%" border="0">
  <tr>
    <td colspan="2" align="center"><h3>จัดสอบความก้าวหน้า รหัส <?=$id?></h3>
          <?  
include('../connectdatabase.php'); 
	  $num = 0;
...
<p>
  ...
  <tr>
    <td width="496" align="right">วันที่จัดสอบ :</td>
  ...
  <tr>
    <td colspan="2" align="center"><input type="button" name="assigexb" id="assigexb" value="จัดสอบ" onclick="assigningex3(<?=$id?>,<?=$idsubmit?>)" />
