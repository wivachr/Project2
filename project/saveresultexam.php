...
<table width="100%" border="0">
  <tr>
    <td colspan="2" align="center"><h3>บันทึกผลการสอบหัวข้อของโครงงานพิเศษ รหัส 
    <?=$id?></h3>
              <?  
...
<p>
  ...
  <tr>
    <td width="296" align="right">ผลการสอบ :</td>
    <td width="711" align="left"><input type="radio" name="resultexam" id="r1" value="1" />
    ผ่าน
      <input type="radio" name="resultexam" id="r2" value="0" />
    <label for="r2">ไม่ผ่าน    </label></td>
  </tr>
  <tr>
    <td width="296" align="right" valign="top">ความคิดเห็นเพิ่มเติม :</td>
    <td width="711" align="left"><label for="comment"></label>
    <textarea name="comment" id="comment" cols="70" rows="10"></textarea></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><input type="button" name="saveresult" id="saveresult" value="บันทึกผล" onclick="saving(<?=$id?>,<?=$idsubmit?>)" />
