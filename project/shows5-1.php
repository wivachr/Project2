...
<? if($rs[4]=='1'){ ?>
<td align="left"><a href="javascript:void(0);" onClick="saveresultexam(<?=$rs[0]?>,<?=$rs[3]?>)"><?=$rs[1]?></a></td>
<? }
else if($rs[4]=='2'){
 ?>
<td align="left"><a href="javascript:void(0);" onClick="saveresultexam2(<?=$rs[0]?>,<?=$rs[3]?>)"><?=$rs[1]?></a></td>
<? }
else if($rs[4]=='3'){
 ?>
 <td width="5%" align="left"><a href="javascript:void(0);" onClick="saveresultexam3(<?=$rs[0]?>,<?=$rs[3]?>)"><?=$rs[1]?></a></td>
 <? } ?>
