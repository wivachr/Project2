...
<?
	...
	$sqldupe = "select id_exam from exam where id_project='$idproject' AND id_typeexam='2' AND id_statusproject='20'";
	...
	$sql = "insert into exam values('$id','$idproject','2','','20','','$year','$semester')";
	mysqli_query($connect, $sql);
	$sql = "update project set id_statusproject='11' where id_project='$idproject'";
	mysqli_query($connect, $sql);
