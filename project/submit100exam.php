<? session_start(); include('../change.php');
	...
	/*
	 * ยื่นสอบร้อยเปอร์เซนต์ (typeexam=2). แข็งแกร่งขึ้นตามแพทเทิร์นเดียวกับ regis/registerproject.php
	 * และ project/submittitleexam.php -- ดูคำอธิบายเต็มในไฟล์นั้น. สาระ: insert exam ที่ล้มเงียบ ๆ
	 * (ชน PK ตอนยื่นพร้อมกัน หรือ idproject ว่าง=0) เคยทำให้สถานะ project เดินเป็น '11' โดยไม่มี
	 * exam row ให้ shows2 join -> เจ้าหน้าที่ไม่เห็นการยื่นสอบ.
	 */
