...
<table border="0" align="center" >
    ...
    <? if($master!="")
	{
	  ...
	  ?>
         <tr>
      <td align="right" nowrap="nowrap" scope="row">กรรมการ :</td>
      <td align="left"><?=$gum?>
      </td>
      </tr>
      <? } ?>
  ...
  <input type="button" name="button" id="button" value="จัดสอบ" onclick="assignexam3(<?=$idview?>,<?=$ida?>)" />
<input type="button" name="button2" id="button2" value="ยกเลิก" onclick="cancele()" />
<? 			 
   			}
