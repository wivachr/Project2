...
function checkid()
{
		...
		if(mysqli_num_rows($result)!=0)
		{
			...
			{
					document.getElementById("year").value=<?=$rs[0] ?>;
					document.getElementById("semester").value=<?=$rs[1] ?>;
					document.getElementById("id_subject").value=<?=$rs[3] ?>;
					document.getElementById("sec").value=<?=$rs[4] ?>;
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check();">
  <table width="100%" border="0" align="center" >
    <tr>
      ...
      *
      <span id="cresult" style="color:#F00"></span> <span id="showname" style="color:#030"></span><span id="tel"><br/></span></td>
    </tr>
    <tr>
