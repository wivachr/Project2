...
?>
<iframe src="evaluationform-1.php?id=<?=$id?>" width="750" height="1090" frameborder="0">
</iframe>
<iframe src="evaluationform2-1.php?id=<?=$id?>&namee=<?=urlencode($master." ".$smaster)?>" width="750" height="1090" frameborder="0">
</iframe>
<? 
	for($i=0;$i<$nnnum;$i++)
	{
		?>
<iframe src="evaluationform2-1.php?id=<?=$id?>&namee=<?=urlencode($gum[$i]." ".$sgum[$i])?>" width="750" height="1090" frameborder="0">
</iframe>
        <?
	}
	if($coad!="")
	{
?>
<iframe src="evaluationform2-1.php?id=<?=$id?>&namee=<?=urlencode($coad." ".$scoad)?>" width="750" height="1090" frameborder="0">
</iframe>
<? } ?>
