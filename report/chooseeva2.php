...
<span id="resultt" style="color:#F00"></span>
  <table width="100%" border="0">
    <tr>
      <td colspan="2" align="center"><h3>ออกใบประเมินการสอบร้อยโครงงานพิเศษ รหัส
        <?=$id?>
      </h3></td>
    </tr>
    <tr>
...
<? 			 
  ...
  <p>
    <input type="button" name="button2" id="button2" value="พิมพ์ใบประเมิน"  onClick="window.open('report/big3.php?id=<?=$id?>', '_blank', '')" />
