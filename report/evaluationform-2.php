...
<table width="100%" border="0">
      <tr>
      <td align="right"><strong>รหัสโครงงาน</strong></td>
      <td align="left">&nbsp;</td>
      <td align="left"><?=$rs[0]?></td>
    </tr>
    <tr>
      <td width="25%" align="right"><strong>ชื่อโครงงาน (ภาษาไทย)</strong></td>
      <td width="6%" align="left">&nbsp;</td>
      <td width="69%" align="left"><?=$rs[1]?></td>
    </tr>
  </table>
  <table width="100%" border="0">
    <tr>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td width="32%" align="left"><?=$teacher?></td>
      <td width="46%" align="left"><?=$steacher?></td>
    </tr>
      <tr>
      <td width="22%" align="left"><strong>อาจารย์ที่ปรึกษาร่วม</strong></td>
      <td width="32%" align="left"><? if($coad==""){echo "-";}else{echo $coad;}?></td>
      <td width="46%" align="left"><? echo $scoad;?></td>
    </tr>
  </table>
  <table width="100%" border="0">
    <tr>
    ...
    <? } ?>
        <tr>
      <td colspan="3" align="right" class="font2">&nbsp;</td>
    </tr>
  </table>
  <table width="100%" border="0">
    <tr>
      <td height="24" colspan="4"><strong>ผลการสอบ<?=$subject?></strong></td>
    </tr>
        <tr class="font2">
      <td colspan="4" class="font2">&nbsp;</td>
    </tr>
    <tr>
      <td width="15%">&nbsp;</td>
      <td width="4%"><img src="../image/checkbox.jpg" width="22" height="24" /></td>
      <td width="32%" valign="middle"><strong>ผ่าน</strong></td>
      <td width="49%" valign="bottom">&nbsp;</td>
    </tr>
    <tr>
      <td width="15%">&nbsp;</td>
      <td width="4%"><img src="../image/checkbox.jpg" width="22" height="24" /></td>
      <td width="32%" valign="middle"><strong>ผ่านแบบมีเงื่อนไข</strong></td>
      <td width="49%" valign="bottom">...................................................................</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><img src="../image/checkbox.jpg" alt="" width="22" height="24" /></td>
      <td valign="middle"><strong>ไม่ผ่านยื่นสอบใหม่ภายในช่วงเวลา</strong></td>
      <td valign="bottom">...................................................................</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><img src="../image/checkbox.jpg" alt="" width="22" height="24" /></td>
      <td valign="middle"><strong>ไม่ผ่าน(F)</strong></td>
      <td valign="bottom">...................................................................</td>
    </tr>
  </table>
</div>
<div id="apDiv4" align="center">
  <h3><strong>แบบประเมินโครงงานพิเศษ  ภาควิชาเทคโนโลยีสารสนเทศ</strong></h3>
...
<table width="100%" height="1080" border="1" bordercolor="#000000">
      <tr>
        <td height="130" colspan="3" align="right" valign="middle"><center>
          <h3>&nbsp;</h3>
        </center>          <h3>&nbsp;</h3></td>
  </tr>
      <tr>
