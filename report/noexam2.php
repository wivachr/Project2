...
$pdf->Cell(180,10,iconv( 'UTF-8','cp874//IGNORE' ,"รายชื่อโครงงานที่ยังไม่ยื่นสอบร้อยเปอร์เซ็นต์เมื่อใก้ลครบกำหนด"),0,1,'C');
 include('../connectdatabase.php'); 
	...
	{
	$pdf->Row(array( iconv( 'UTF-8','cp874//IGNORE' ,"รหัสโครงงานพิเศษ"),iconv( 'UTF-8','cp874//IGNORE' ,"ชื่อโครงงานพิเศษ")));
