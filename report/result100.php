...
<p>
  <center><input type="button" name="button" id="button" value="ออกรายงาน" onclick="window.open('report/result100pdf.php?teacher=<?=(int)$teacher?>&y=<?=htmlspecialchars($y,ENT_QUOTES)?>&s=<?=htmlspecialchars($s,ENT_QUOTES)?>','_blank','')" /></center>
</p>
<?
	}
	else
