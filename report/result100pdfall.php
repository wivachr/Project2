...
class PDF extends PDF_MC_Table
{
	...
	function Header(){
		...
		$this->Text(100,10,iconv( 'UTF-8','cp874//IGNORE' ,"รายงานผลการสอบร้อยเปอร์เซ็นต์ ประจำภาคเรียน ".$_GET["s"]." ปีการศึกษา ".$_GET["y"]));
		$this->Text(119,20,iconv( 'UTF-8','cp874//IGNORE' ,'คณะเทคโนโลยีและการจัดการอุตสาหกรรม'));
