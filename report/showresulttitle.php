 ...
 function cct()
{
	...
	var ss = Math.random();
	if(t==-1)
	$("#examstatus").load("report/resulttitleall.php?.php?pop="+ss+"&y="+y+"&s="+s);
	else
	$("#examstatus").load("report/resulttitle.php?.php?pop="+ss+"&teacher="+t+"&y="+y+"&s="+s);
}
</script>
</head>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<h2>ผลการสอบหัวข้อโครงงานพิเศษ</h2>
<p>&nbsp;</p>
<p>อาจารย์ที่ปรึกษา : 
  <select name="t" id="t">
